...
function(register_extra_modules)
    ...
    function(generate_fake_dev_package NS)
        ...
        endforeach()
        if ("${NS}" STREQUAL "openvino")
            file(APPEND "${devconfig_file}" "add_library(${NS}::runtime ALIAS openvino_preproc)\n")
            file(APPEND "${devconfig_file}" "add_library(${NS}::runtime::dev ALIAS openvino_preproc_dev)\n")
        endif()
    endfunction()
